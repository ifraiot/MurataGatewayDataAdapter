...
func main() {
	...
	for {
		...
		if len(node1) > 20 && canSend(node1, timeStamps) {
			...
			fmt.Println("BREAKDOWN_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("BREAKDOWN_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("1st_Freq_BREAKDOWN", data.F1)
			ifra.AddMeasurement("1st_Acc_BREAKDOWN", data.A1)
			ifra.AddMeasurement("2nd_Freq_BREAKDOWN", data.F2)
			ifra.AddMeasurement("2nd_Acc_BREAKDOWN", data.A2)
			ifra.AddMeasurement("3rd_Freq_BREAKDOWN", data.F3)
			ifra.AddMeasurement("3rd_Acc_BREAKDOWN", data.A3)
			ifra.AddMeasurement("4th_Freq_BREAKDOWN", data.F4)
			ifra.AddMeasurement("4th_Acc_BREAKDOWN", data.A4)
			ifra.AddMeasurement("5th_Freq_BREAKDOWN", data.F5)
			ifra.AddMeasurement("5th_Acc_BREAKDOWN", data.A5)
			ifra.AddMeasurement("BREAKDOWN_Temp",data.Temp)
			ifra.Send()
		}
		...
		if len(node2) > 20 && canSend(node2, timeStamps) {
			...
			fmt.Println("FINPASS_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("FINPASS_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("1st_Freq_FINPASS", data.F1)
			ifra.AddMeasurement("1st_Acc_FINPASS", data.A1)
			ifra.AddMeasurement("2nd_Freq_FINPASS", data.F2)
			ifra.AddMeasurement("2nd_Acc_FINPASS", data.A2)
			ifra.AddMeasurement("3rd_Freq_FINPASS", data.F3)
			ifra.AddMeasurement("3rd_Acc_FINPASS", data.A3)
			ifra.AddMeasurement("4th_Freq_FINPASS", data.F4)
			ifra.AddMeasurement("4th_Acc_FINPASS", data.A4)
			ifra.AddMeasurement("5th_Freq_FINPASS", data.F5)
			ifra.AddMeasurement("5th_Acc_FINPASS", data.A5)
			ifra.AddMeasurement("FINPASS_Temp", data.Temp)
			ifra.Send()
		}
		...
		if len(node3) > 20 && canSend(node3, timeStamps) {
			...
			fmt.Println("SIZING_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("SIZING_BatteryVoltage", data.Battery)
			ifra.AddMeasurement("1st_Freq_SIZING", data.F1)
			ifra.AddMeasurement("1st_Acc_SIZING", data.A1)
			ifra.AddMeasurement("2nd_Freq_SIZING", data.F2)
			ifra.AddMeasurement("2nd_Acc_SIZING", data.A2)
			ifra.AddMeasurement("3rd_Freq_SIZING", data.F3)
			ifra.AddMeasurement("3rd_Acc_SIZING", data.A3)
			ifra.AddMeasurement("4th_Freq_SIZING", data.F4)
			ifra.AddMeasurement("4th_Acc_SIZING", data.A4)
			ifra.AddMeasurement("5th_Freq_SIZING", data.F5)
			ifra.AddMeasurement("5th_Acc_SIZING", data.A5)
			ifra.AddMeasurement("SIZING_Temp", data.Temp)
			ifra.Send()
		}
